...
const DEFAULT_ITEMS: HomepageCategorySliderItem[] = [
  { id: 'klassiek', label: 'Klassiek', href: '/trouwjurken', image_url: '' },
  { id: 'bohemian', label: 'Bohemian', href: '/boho', image_url: '' },
  { id: 'romantisch', label: 'Romantisch', href: '/trouwjurken', image_url: '' },
  { id: 'strak', label: 'Strak', href: '/trouwjurken', image_url: '' },
  { id: 'open-rug', label: 'Open rug', href: '/trouwjurken', image_url: '' },
  { id: 'sexy', label: 'Sexy', href: '/trouwjurken', image_url: '' },
  { id: 'simpel', label: 'Simpel', href: '/trouwjurken', image_url: '' },
  { id: 'vintage', label: 'Vintage', href: '/trouwjurken', image_url: '' },
